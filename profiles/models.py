...
class Profile(models.Model):
    user=models.OneToOneField(User) #we not do foreign key because than one user can have different profiles but we dont want it.
...
class UserJob(models.Model):
    user=models.ForeignKey(User)#har user ki multiple job ho sakti hain ek hie user ki ,isliye foreign key.
